...
import { AppName } from "../../common/links";
  ...
  return (
    <div className="">
      ...
      <section class="text-black body-font">
        <div class="container mx-auto flex px-5 md:px-12 py-20 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="title-font sm:text-5xl text-3xl mb-4 font-medium text-gray-900">Before they sold out
              <br class="hidden lg:inline-block" /><span className='sm:text-4xl text-3xl' >readymade gluten</span>
            </h1>
            <p class="mb-8 sm:text-lg leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
            {user ? <Link to="/dashboard" class="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-black/80 rounded text-lg">Your Space</Link> : <Link to="/auth" class="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-black/80 rounded text-lg">Access Now</Link>}
          </div>
            ...
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-black">UI Designer</p>
                </div>
              </div>
            </div>
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            ...
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-black">UX Researcher</p>
                </div>
              </div>
            </div>
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-black">QA Engineer</p>
                </div>
              </div>
            </div>
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            ...
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-black">Product Manager</p>
                </div>
              </div>
            </div>
          </div>
