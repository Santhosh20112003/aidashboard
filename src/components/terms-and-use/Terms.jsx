            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-800">
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CodeSpark.</li>
                        ...
                        <li><strong>Website:</strong> Refers to CodeSpark, accessible from <a href="https://codesparkk.vercel.app" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">codesparkk.vercel.app</a>.</li>
