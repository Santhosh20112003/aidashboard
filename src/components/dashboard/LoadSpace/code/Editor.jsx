...
function Editor({ editorData, setCloudSync }) {
    const editorRef = useRef(null);
    var data = editorData;
    const { spaceid, UpdateExistingSpace, setNotes, explanation } = useData();
                ...
                const newEditor = new EditorJS({
                    ...
                    onChange: async () => {
                        try {
                            ...
                            const response = await UpdateExistingSpace(updatedSpace);
